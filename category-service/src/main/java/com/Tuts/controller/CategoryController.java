...
public class CategoryController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Set<Category>> getAllCategoriesByBarberShopId(@PathVariable Long id) {
        Set<Category> categories = categoryService.getAllCategoriesByBarberShopId(id);
